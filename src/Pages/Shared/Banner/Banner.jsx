          ...
          <div className="flex flex-col lg:flex-row items-center lg:justify-between p-8">
            ...
            <div className="w-full lg:w-1/2 lg:text-left mt-4 lg:mt-0 lg:pl-8">
              ...
              <p className="mt-2 lg:mt-4">
                ...
                World of Culinary Marvels Where Japanese Tradition Meets
                Exquisite Fusion. Experience an Epicurean Adventure with
                Hand-Rolled Sushi, Sizzling Teppanyaki, and Artfully Crafted
                Ramen. Immerse Yourself in the Vibrant Ambiance and Captivating
                Flavors of Authentic Japanese Cuisine. A Feast for the Senses
                Awaits at Baratie Restaurant - Where Gastronomic Delights Become
